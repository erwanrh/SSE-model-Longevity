...
source('Scripts_Spain/01_Model_Fit_Spain.R')

####################################################################################-
#---------------------------3. SPLINES / COEFF PLOTS  ----------------------------
####################################################################################-
country_code <-  'ESP'
source('Scripts_Spain/02_Plots_Spain.R')


####################################################################################-
#---------------------------5. COMPONENTS COMPUTATION / PLOTS  ----------------------------
####################################################################################-
source('Scripts_Spain/05_Functions_Plots_Spain.R')
source('Scripts_Spain/05_Functions_Plots_Females_Spain.R')
...
png('ESP_fit_allmx.png', width= 3000, height=2500, res=300)
...
png('allcompallyearsESP.png', width= 2600, height=3000, res=250)
...
source('Scripts_Spain/04_SensisFunctions_Spain.R')
source('Scripts_Spain/04_SensisFunctions_Females_Spain.R')
...
png('comp_imp_ESP.png', width = 4000, height = 4000, res = 500)
p2
dev.off()
...
png('comp_evolution_graph_ESP.png',  width = 5000, height = 3000, res = 600)
plot_selectedyears_allComp(c(2000,2016)) + ggtitle('Composantes SSE Esapgne en 2000 et 2016') + 
...
ggsave(filename = 'corrplot_ESP1.png', plot = corr_F, height=10, width = 7, bg = 'transparent')
...
#---------------------------9. MODEL ROBUSTESS   ----------------------------
####################################################################################-
source('Scripts_Spain//07_Robustess_Spain.R')


####################################################################################-
#---------------------------10. OPTIMIZATION   ----------------------------
####################################################################################-
source('Scripts_Spain//08_OptimFun_Spain.R')

p1 <- plot_allcompRawData(2016)
ggsave(p1, filename='2016_allcomp_plot.png', width = 8, height = 5)

optimization1 <- optimize_LE(target_LE = 4, perc_Infant = 0.5)
