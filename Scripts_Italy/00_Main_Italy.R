...
source('Scripts_Italy/01_Model_Fit_Italy.R')

####################################################################################-
#---------------------------3. SPLINES / COEFF PLOTS  ----------------------------
####################################################################################-
country_code <-  'ITA'
source('Scripts_Italy/02_Plots_Italy.R')


####################################################################################-
#---------------------------5. COMPONENTS COMPUTATION / PLOTS  ----------------------------
####################################################################################-
source('Scripts_Italy/05_Functions_Plots_Italy.R')
source('Scripts_Italy/05_Functions_Plots_Females_Italy.R')
...
png('ITA_fit_allmx.png', width= 1500, height=1300, res=300)
...
png('allcompallyearsITA.png', width= 2600, height=3000, res=250)
...
source('Scripts_Italy/04_SensisFunctions_Italy.R')
source('Scripts_Italy/04_SensisFunctions_Females_Italy.R')
...
png('comp_imp_ITA.png', width = 4000, height = 4000, res = 500)
p2
dev.off()
...
png('comp_evolution_graph_ITA.png',  width = 5000, height = 3000, res = 600)
plot_selectedyears_allComp(c(2000,2016)) + ggtitle('Composantes SSE Italie en 2000 et 2016') + 
...
ggsave(filename = 'corrplot_ITA1.png', plot = corr_F, height=10, width = 7, bg = 'transparent')
...
#---------------------------9. MODEL ROBUSTESS   ----------------------------
####################################################################################-
source('Scripts_Italy//07_Robustess_Italy.R')


####################################################################################-
#---------------------------10. OPTIMIZATION   ----------------------------
####################################################################################-
source('Scripts_Italy//08_OptimFun_Italy.R')
