...
png('comp_imp_FRA5.png', width = 4000, height = 4000, res = 500)
p2
dev.off()
...
ggsave(filename = 'corrplot_FRA4.png', plot = corr_F, height=10, width = 7, bg = 'transparent')
...
p1 <- plot_allcompRawData(2017)
ggsave(p1, filename='2016_allcomp_plot.png', width = 8, height = 5)

optimization1 <- optimize_LE(target_LE = 4, perc_Infant = 1)
