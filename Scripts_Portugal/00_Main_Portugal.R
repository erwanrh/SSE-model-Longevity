######## SCRIPT MODEL SSE data for Portugal #######-
...
source('Scripts_Portugal/01_Model_Fit_Portugal.R')

####################################################################################-
#---------------------------3. SPLINES / COEFF PLOTS  ----------------------------
####################################################################################-
country_code <-  'MAR'
source('Scripts_Portugal/02_Plots_Portugal.R')


####################################################################################-
#---------------------------5. COMPONENTS COMPUTATION / PLOTS  ----------------------------
####################################################################################-
source('Scripts_Portugal/05_Functions_Plots_Portugal.R')
source('Scripts_Portugal/05_Functions_Plots_Females_Portugal.R')
